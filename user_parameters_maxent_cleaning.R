...
occurrence_data_dir_processed <- paste0(occurrence_data_dir, '/Processed/')
maxent_output_dir <- "E:/Phylo_modelling/Output/Maxent"

charts_output_dir <- "E:/Phylo_modelling/Output/Charts"

# Version of maxent run
maxent_run_version <- "V2"

# species list file name
species_list <- paste0(spdir, '0_Species_list.rdata')

# occurrence background file name for maxent
maxent_background <- paste(spdir, '10000_CA_plants_bg_1080m.rdata', sep='')

# string for searching correct environmental data file names
searchString <- '1080m'
